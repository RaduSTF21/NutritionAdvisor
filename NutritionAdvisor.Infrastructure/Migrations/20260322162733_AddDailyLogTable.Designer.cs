...
namespace NutritionAdvisor.Infrastructure.Migrations
{
    ...
    [Migration("20260322162733_AddDailyLogTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailyLogRecipe", b =>
                {
                    b.Property<Guid>("ConsumedRecipesId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("DailyLogId")
                        .HasColumnType("uuid");

                    b.HasKey("ConsumedRecipesId", "DailyLogId");

                    b.HasIndex("DailyLogId");

                    b.ToTable("DailyLogRecipes", (string)null);
                });
            ...
            modelBuilder.Entity("DailyLogRecipe", b =>
                {
                    b.HasOne("NutritionAdvisor.Domain.Entities.Recipe", null)
                        .WithMany()
                        .HasForeignKey("ConsumedRecipesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NutritionAdvisor.Domain.Entities.DailyLog", null)
                        .WithMany()
