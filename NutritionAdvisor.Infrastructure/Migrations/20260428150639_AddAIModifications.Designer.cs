...
namespace NutritionAdvisor.Infrastructure.Migrations
{
    ...
    [Migration("20260428150639_AddAIModifications")]
    partial class AddAIModifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NutritionAdvisor.Domain.Entities.FoodPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NutritionAdvisor.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("SubscriptionStartAt")
                        .HasColumnType("timestamp with time zone");
